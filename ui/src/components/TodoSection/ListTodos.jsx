  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      {isTodoEdit && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-indigo-500 font-semibold rounded-md shadow-md hover:bg-red-600  transition"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="w-full py-3 px-4 bg-red-600  text-white font-semibold rounded-md shadow-md hover:bg-indigo-700 transition"
          >
            Update Todo
          </button>
          </div>
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-xl font-semibold mb-4">Active Todos</h2>
          ...
          <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
            ...
            <tbody>
              {todos
                ...
                .map((todo) => (
                  <tr key={todo.id} className="hover:bg-gray-100 transition">
                    <td className="px-4 py-2 border-b text-left line-through text-gray-500">
                      {todo.title}
                    </td>
                    <td className="px-4 py-2 border-b text-left line-through text-gray-500">
                      {todo.description}
